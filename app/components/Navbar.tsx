...
import { LuBookDashed } from "react-icons/lu"; // Add this import at the top
  ...
  return (
    <nav className="flex justify-between items-center xxs:px-2 md:px-6 py-3 bg-indigo-300 dark:bg-gray-950 shadow">
      ...
      <div className="flex-1 flex justify-center xxs:space-x-1 md:space-x-3">
        ...
        >
          <LuBookDashed className="text-red-400 text-base md:text-lg transition-transform duration-300 group-hover:scale-110 group-hover:-translate-y-0.5" />
