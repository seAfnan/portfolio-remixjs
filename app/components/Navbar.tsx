...
export default function Navbar() {
  ...
  return (
    <nav className="flex justify-between items-center xxs:px-1 md:px-6 py-3 bg-indigo-400 dark:bg-gray-950 shadow">
      {/* Centered Links */}
      <div className="flex-1 flex justify-center xxs:space-x-1 md:space-x-3">
        ...
        >
          {/* <button className="relative px-3 xxs:py-1.5 md:py-1 xxs:text-xs md:text-sm font-bold bg-white text-gray-900 rounded-sm overflow-hidden group"> */}
