...
const HireMe = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen p-1 bg-gradient-to-b from-indigo-400 via-indigo-300 to-indigo-200 text-black dark:bg-gradient-to-b dark:from-gray-950 dark:via-gray-950 dark:to-black dark:text-white">
      <Form
        method="post"
        onSubmit={handleSubmit}
        className="bg-gray-100 dark:bg-gray-900/30 p-6 w-full max-w-lg relative xxs:top-[2vh] lg:top-[-5vh] border-l border-r dark:border-l-0 dark:border-r-0 shadow-sm dark:shadow-gray-800 hover:shadow-lg dark:hover:shadow-stone-800 transition-shadow duration-300"
      >
